    ...
    .then(function () {
      ...
      return knex('skills').insert([
        ...
        },
        {
          ...
          name: 'Zanbato+(eff)',
          description: `Effective against cavalry foes.
          Neutralizes cavalry foes' bonuses (from
          skills like Fortify, Rally, etc.) during combat.`,
          type: 'sword',
          mt: 14,
          hp: 3,
        ...
        },
        {
          id: 100041,
          name: 'Ruby Sword',
          description: `If unit has weapon-triangle advantage,
          boosts attack by 20%. If unit has weapon-triangle
          disadvantage, reduces attack by 20%.`,
          type: 'sword',
          mt: 8
        },
        {
          ...
          name: 'Ruby Sword+',
          description: `If unit has weapon-triangle advantage,
          boosts attack from 20%. If unit has weapon-triangle
          disadvantage, reduces attack by 20%.`,
          type: 'sword',
          mt: 14
        },
        ...
        },
        {
          id: 100045,
          name: 'Safeguard',
          description: `If foe initiates combat, grants
          Def+7 during combat.`,
          type: 'sword',
          mt: 10
        },
        ...
        },
        {
          ...
          name: 'Folkvangr',
          prf: true,
          description: `At start of turn, if unit's HP ≤ 50%, grants Atk+5
          for 1 turn.`,
          type: 'sword',
          mt: 16
        },
        {
          ...
          name: 'Folkvangr(eff)',
          prf: true,
          description: `At start of combat, if unit's HP ≤ 80%, grants
        ...
        },
        {
          ...
          name: 'Niu',
          prf: true,
          description: `Grants Spd+3. Adds 50% of total bonuses on foe to unit's
          Atk/Spd/Def/Res during combat.`,
          type: 'sword',
          mt: 16,
          spd: 3
        },
        {
          ...
          name: 'Laevatein',
          prf: true,
          description: `Grants Atk+3. Adds total bonuses on unit
          to damage dealt.`,
          type: 'sword',
          mt: 16,
          atk: 3
        },
        {
          ...
          prf: true,
          description: `Effective against dragon foes. At the start of every
        ...
        },
        {
          ...
          prf: true,
          description: `Effective against dragon foes. At the start of
